...
function ssh_remote_command() {
	...
	typeset -r socket_name="${USER}.tmux.socket"
	...
	typeset -r tmux_remote_command="tmux -L '$socket_name' new-session -A -s '$session_name' $tmux_config \; set-option -g prefix C-b"
